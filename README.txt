...
если запрос прошел нормально (код ответа 200 Successful authorization), то вы все сделали верно и API готова к использованию, если это не так то вернитесь к пункту 1
